// Growth Green Theme - Reusable Pitch Deck Template
// Palette: growth-green
// Colors: #047857 (titles), #065f46 (subtitles), #34d399 (accent), #f0fdf4 (bg), #1a202c (body)
// Typography: Montserrat headings, Inter body (dark text on mint)
// Best for: Sustainability, health, climate tech, clean energy, agriculture
...
// == PALETTE ===================================================================
#let palette-primary   = rgb("#047857")  // Emerald -- titles, headings
#let palette-secondary = rgb("#065f46")  // Dark green -- subtitles, metadata
#let palette-accent    = rgb("#34d399")  // Light green -- emphasis, links, markers
#let palette-bg        = rgb("#f0fdf4")  // Mint -- page background
...
#speaker-note[
  ...
  The green palette signals sustainability and growth -- let that work for you.
...
#speaker-note[
  Lead with the pain. For sustainability pitches, quantify the environmental
  or health cost. Investors in this space respond to urgency and scale of impact.
...
#speaker-note[
  Show, do not tell. If you have impact data or before/after comparisons, use them.
  Explain the solution in terms of the problem you just described.
  For climate/health tech, emphasize measurable outcomes and scalability.
]
...
#speaker-note[
  ...
  For impact-focused companies, include both financial and impact metrics.
...
#speaker-note[
  ...
  For sustainability/climate, regulatory tailwinds (IRA, EU Green Deal) are powerful.
  Emphasize domain expertise in the specific sector you are targeting.
]
...
#speaker-note[
  ...
  For impact companies, show that doing good and making money are aligned.
]
...
#speaker-note[
  ...
  Sustainability markets are growing rapidly -- cite growth rates.
  Include regulatory drivers that expand the addressable market.
]
...
#speaker-note[
  ...
  Highlight domain expertise in sustainability, science, or regulatory knowledge.
  If you have advisors from major environmental organizations, mention them.
]
...
#speaker-note[
  End with energy and purpose. Restate your impact thesis and invite questions.
  Have your appendix slides ready for deep-dive questions on impact metrics.
...
//   - Impact metrics and measurement methodology
