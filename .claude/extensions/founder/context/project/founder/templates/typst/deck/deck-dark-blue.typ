// Dark-Blue Theme - Reusable Pitch Deck Template (PRIMARY/DEFAULT)
// Palette: dark-blue
...
//
// This is the PRIMARY/DEFAULT template. Dark themes are preferred.
// For other styles see: deck-minimal-light.typ, deck-premium-dark.typ,
//   deck-growth-green.typ, deck-professional-blue.typ
...
//
// Usage example: #text(size: 28pt)[Detail content here]
...
// == CARD PATTERN (visual containers for comparisons) =========================
...
#speaker-note[
  Lead with the pain. Use a specific example or customer quote if possible.
  Investors fund problems, not solutions. Make them feel the urgency.
...
#speaker-note[
  Show, do not tell. If you have a demo or screenshot, this is where it goes.
  Explain the solution in terms of the problem you just described.
  Use concrete language: "We do X, which means Y for the customer."
]
...
#speaker-note[
  ...
  The "why now" should explain what changed that makes this possible today.
]
...
#speaker-note[
  ...
  If solo founder, explain your hiring plan for the first 2-3 key roles.
]
