...
{
  "status": "completed",
  "summary": "Research completed on API integration. Found official documentation. Recommend implementing core endpoints first.",
  "artifacts": [
    {
      "type": "research",
      "path": "specs/195_api_tools/reports/01_api-tools-research.md",
  ...
  "errors": [],
  "next_steps": "Create implementation plan for API integration"
}
```
...
{
  "status": "failed",
  "summary": "Failed to implement configuration due to dependency error. Checked configuration and attempted fallback. Both approaches failed.",
  "artifacts": [],
  "metadata": {
