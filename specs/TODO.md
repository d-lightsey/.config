...
- **456** [COMPLETED] -- Fix documentation regressions from agent system update
...
- **Status**: [PLANNED]
- **Task Type**: meta
- **Research**: [specs/457_design_extension_slidev_resource_distribution/reports/01_team-research.md]
- **Plan**: [457_design_extension_slidev_resource_distribution/plans/01_slidev-resource-distribution.md]
...
- **Status**: [COMPLETED]
- **Task Type**: meta
- **Research**: [456_fix_doc_regressions_agent_system_update/reports/01_fix-doc-regressions.md]
- **Plan**: [456_fix_doc_regressions_agent_system_update/plans/01_fix-doc-regressions.md]
- **Summary**: [456_fix_doc_regressions_agent_system_update/summaries/01_fix-doc-regressions-summary.md]
